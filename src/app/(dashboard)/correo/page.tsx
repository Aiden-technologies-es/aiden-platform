  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <p className="text-[11px] font-bold text-[#9A9AB0] uppercase tracking-widest mb-1">Servicios</p>
          <h1 className="text-3xl font-black text-[#0A0A0F] tracking-tight">Correo electrónico</h1>
        </div>
      ...
      <Card>
        ...
        <CardBody className="pt-0">
          {mailboxes.length === 0 ? (
            <EmptyState icon="📧" title="Sin buzones" description="Crea tu primer buzón de correo profesional." action={<Link href="/correo/nuevo"><Button variant="brand" size="sm">Crear buzón</Button></Link>}/>
          ) : (
